...
export default function AlohaCleaning() {
  ...
  return (
    <section ref={ref} id="aloha-cleaning" className="bg-primary text-ink">
      <div className="max-w-[1400px] mx-auto px-6 md:px-12 py-24">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start">
          ...
          <div>
            <motion.p
              className="text-[10px] uppercase tracking-[0.2em] text-ink/50 font-medium mb-4"
            ...
            >
              Aloha <span className="text-ink/40">Cleaning</span>
            </motion.h3>

            <motion.p
              className="text-base md:text-lg text-ink/70 leading-relaxed mb-12 max-w-md"
              initial={{ y: 60, opacity: 0 }}
              animate={isInView ? { y: 0, opacity: 1 } : { y: 60, opacity: 0 }}
            ...
            <ol className="space-y-8 mb-12">
              {benefits.map((b, i) => (
                ...
                >
                  <span className="font-kondolar text-xl font-black text-ink/30 leading-none pt-0.5">
                    {b.num}
                  </span>
                  <div>
            ...
            >
              <Link
                href="#contacto"
                className="inline-flex items-center gap-3 border border-ink/40 text-ink px-8 py-4 text-xs uppercase tracking-[0.15em] font-medium hover:bg-ink hover:text-cream transition-all duration-300 group"
              >
